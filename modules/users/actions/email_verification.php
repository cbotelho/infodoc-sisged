...
switch($app_module_action)
{
    ...
    case 'update_email':
        ...
        {
            $check_query = db_query("select count(*) as total from app_entity_1 where field_9='" . db_input($_POST['email']) . "'  and id!='" . db_input($app_user['id']) . "'");
            ...
            {
                //update account
                db_query("update app_entity_1 set field_9='" . db_input($_POST['email']) . "' where id='" . $app_user['id'] . "'");
