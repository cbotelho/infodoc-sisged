...
if($report_info = db_fetch_array($reports_query))
{
	...
	$listing_sql_query_select = fieldtype_formula::prepare_query_select($report_info['entities_id'], $listing_sql_query_select,false,array('reports_id'=>$report_info['id']));
