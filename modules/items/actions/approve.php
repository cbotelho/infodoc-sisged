...
//run process			
        ...
        switch($app_redirect_to)
        {
            ...
            default:
                ...
                {
                    redirect_to('items/info', 'path=' . str_replace('related_records_info_page_','',$app_redirect_to));
                }
    ...
    case 'cancel_approve':
        ...
        db_query("delete from app_approved_items where entities_id={$current_entity_id} and items_id={$current_item_id} and fields_id='" . _get::int('fields_id') . "' and users_id={$app_user['id']}");
