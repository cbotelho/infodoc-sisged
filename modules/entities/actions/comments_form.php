...
switch($app_module_action)
{
    case 'save_javascript':
        ...
        $cfg->set('javascript_in_comments_from', $_POST['javascript_in_comments_from']);
        $cfg->set('javascript_comments_from_onsubmit', $_POST['javascript_comments_from_onsubmit']);
