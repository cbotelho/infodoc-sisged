...
switch($app_module_action)
{
        ...
        while($tabs = db_fetch_array($tabs_query))
        {
            if(isset($_POST['forms_rows_' . $tabs['id']]))
            {
                ...
                foreach(explode(',',str_replace('forms_rows_','',$_POST['forms_rows_' . $tabs['id'] ])) as $v)
                {
                    ...
                    db_query("update app_fields set forms_tabs_id='" . $tabs['id'] . "' where entities_id='" . _GET('entities_id'). "' and forms_rows_position in ('" . $v . ":1','" . $v . ":2','" . $v . ":3','" . $v . ":4','" . $v . ":5','" . $v . ":6')");
                }
            }
        }
        exit();
    ...
    case 'delete':
        ...
        if(isset($_GET['id']))
        {
            ...
            $v = _GET('id');
            db_query("update app_fields set forms_rows_position='' where entities_id='" . _GET('entities_id'). "' and forms_rows_position in ('" . $v . ":1','" . $v . ":2','" . $v . ":3','" . $v . ":4','" . $v . ":5','" . $v . ":6')");
        }
