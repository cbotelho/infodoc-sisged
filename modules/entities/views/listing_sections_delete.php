...
<?php echo form_tag('login', url_for('entities/listing_sections','action=delete&id=' . $_GET['id'] . '&listing_types_id=' . $_GET['listing_types_id'] . '&entities_id=' . $_GET['entities_id'])) ?>
