...
<?php 
	...
	$access_schema = [];
	$access_schema_info_query = db_query("select * from app_user_roles_access where user_roles_id='" . _get::int('role_id') . "' and entities_id='" . _get::int('role_entities_id') . "' and fields_id='" . _get::int('fields_id') . "'");
