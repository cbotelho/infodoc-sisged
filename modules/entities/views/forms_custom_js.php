...
<?php echo form_tag('fields_form', url_for('entities/forms','action=save_javascript&entities_id=' . $_GET['entities_id']),array('class'=>'form-horizontal','enctype'=>'multipart/form-data')) ?>
