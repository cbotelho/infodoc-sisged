...
<?php echo button_tag(TEXT_BUTTON_ADD_NEW_REPORT_FILTER,url_for('entities/entityfield_filters_form','reports_id=' . $reports_info['id'] . '&entities_id=' . $_GET['entities_id'] . '&fields_id=' . $_GET['fields_id'])) . ' ' . button_tag(TEXT_BUTTON_CONFIGURE_SORTING,url_for('reports/sorting','reports_id=' . $reports_info['id'] . '&redirect_to=entityfield_filters&fields_id=' . $_GET['fields_id'])) ?>
...
?>
  <tr>
    <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('entities/entityfield_filters_delete','id=' . $v['id'] . '&reports_id=' . $reports_info['id']. '&entities_id=' . $_GET['entities_id']. '&fields_id=' . $_GET['fields_id'])) . ' ' . button_icon_edit(url_for('entities/entityfield_filters_form','id=' . $v['id'] . '&reports_id=' . $reports_info['id']. '&entities_id=' . $_GET['entities_id']. '&fields_id=' . $_GET['fields_id']))  ?></td>    
