...
<?php echo form_tag('reports_filters', url_for('entities/fields_choices_filters','action=save&choices_id=' . $_GET['choices_id'] . (isset($_GET['id']) ? '&id=' . $_GET['id']:''). '&entities_id=' . $_GET['entities_id'] . '&fields_id=' . $_GET['fields_id']),array('class'=>'form-horizontal')) ?>
