...
<?php 
    $access_choices_default = array('yes'=>TEXT_YES, 'view'=>TEXT_VIEW_ONLY, 'view_inform'=>TEXT_VIEW_PLUS_DISPLAY_IN_FORM, 'hide'=>TEXT_HIDE);
...
?>  	
      ...
      <div class="form-group">
	    ...
	    <div class="col-md-9">	
	  	  <?php echo select_tag('access_template',[''=>'']+$access_choices, '',array('class'=>'form-control input-large')) ?>
	    </div>			
	  </div> 
...
?>  	
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-md-9">	
	  	  <?php echo select_tag('access[' . $groups['id']. ']',$access_choices, $value,array('class'=>'form-control input-large acess-group-cfg access_group_' . $groups['id'])) ?>
	    </div>			
	  </div> 
<?php 
  } 
...
function check_is_heading_option()
{
   ...
   if($.inArray(selected_type,["fieldtype_related_mail","fieldtype_google_map_nested","fieldtype_yandex_map_nested","fieldtype_yandex_map_directions","fieldtype_yandex_map","fieldtype_color","fieldtype_nested_calculations","fieldtype_subentity_form","fieldtype_input_encrypted","fieldtype_textarea_encrypted","fieldtype_video","fieldtype_ajax_request","fieldtype_digital_signature","fieldtype_time","fieldtype_iframe","fieldtype_input_protected","fieldtype_google_map","fieldtype_mapbbcode","fieldtype_todo_list","fieldtype_mysql_query","fieldtype_image_map","fieldtype_mind_map","fieldtype_section","fieldtype_input_numeric_comments","fieldtype_input_url","fieldtype_attachments","fieldtype_onlyoffice","fieldtype_input_file","fieldtype_image","fieldtype_image_ajax","fieldtype_3dviewer","fieldtype_textarea_wysiwyg","fieldtype_formula","fieldtype_related_records","fieldtype_boolean","fieldtype_boolean_checkbox"])==-1)
   {
