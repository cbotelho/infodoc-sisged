...
<?php echo form_tag('reports_filters', url_for('entities/listing_filters','action=save&reports_id=' . $_GET['reports_id'] . (isset($_GET['id']) ? '&id=' . $_GET['id']:''). '&entities_id=' . $_GET['entities_id'] ),array('class'=>'form-horizontal')) ?>
