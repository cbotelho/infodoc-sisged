...
<?php echo form_tag('choices_form', url_for('entities/fields_choices','action=sort_reset&entities_id=' . $_GET['entities_id'] . '&fields_id=' . $_GET['fields_id']),array('class'=>'form-horizontal')) ?>
