...
<?php echo form_tag('login', url_for('entities/fields_filters','action=delete&id=' . $_GET['id'] . '&reports_id=' . $_GET['reports_id']. '&entities_id=' . $_GET['entities_id']. '&fields_id=' . $_GET['fields_id'])) ?>
