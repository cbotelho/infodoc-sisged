...
<?php
    ...
    switch(true)
    {
        ...
        case strstr($app_redirect_to,'help_pages'):
            ...
            break;
        case strstr($app_redirect_to,'xml_export'):
            require(component_path('default_filters/xml_export_breadcrumb'));
            break;
        case strstr($app_redirect_to,'kanban'):
            require(component_path('default_filters/kanban_breadcrumb'));
            break;
        case strstr($app_redirect_to,'gantt'):
            require(component_path('default_filters/gantt_breadcrumb'));
            break;
        case strstr($app_redirect_to,'email_sending_rules'):
            require(component_path('default_filters/email_sending_rules_breadcrumb'));
            break;
        case strstr($app_redirect_to,'sms_rules'):
            require(component_path('default_filters/sms_rules_breadcrumb'));
            break;
...
switch(true)
{
    ...
    case strstr($app_redirect_to,'help_pages'):        
        ...
        break;
    case strstr($app_redirect_to,'xml_export'):
        echo link_to(TEXT_BUTTON_BACK, url_for('ext/xml_export/templates'),array('class'=>'btn btn-default'));
        break;
    case strstr($app_redirect_to,'kanban'):
    ...
    case strstr($app_redirect_to,'gantt'):
        ...
        break;    
    case strstr($app_redirect_to,'email_sending_rules'):
        echo link_to(TEXT_BUTTON_BACK, url_for('ext/email_sending/rules', 'entities_id=' . $rules['entities_id']),array('class'=>'btn btn-default'));
        break;
    case strstr($app_redirect_to,'sms_rules'):
        echo link_to(TEXT_BUTTON_BACK, url_for('ext/modules/sms_rules'),array('class'=>'btn btn-default'));
        break;
