...
$report_info_query = db_query("select * from app_ext_resource_timeline where id=(select calendars_id from app_ext_resource_timeline_entities where id='" . str_replace('resource_timeline_entities','',$app_redirect_to) . "')");
