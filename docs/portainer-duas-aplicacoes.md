...
```env
IMAGE_TAG=1.0.26
WEB_IMAGE_TAG=1.0.34
WORKER_IMAGE_TAG=1.0.34
SIGNER_IMAGE_TAG=1.0.34
APP_PORT=8081
SIGNER_PORT=5000
...
GED_ENABLE_INLINE_OCR=0
GED_ENABLE_SYNC_R2_UPLOAD=1
...
8. Confirme que as tags da stack estao corretas para cada servico. Exemplo atual: `WEB_IMAGE_TAG=1.0.34`, `WORKER_IMAGE_TAG=1.0.34` e `SIGNER_IMAGE_TAG=1.0.34`.
...
5. Valide a abertura de um PDF ja carregado pelo GED usando a URL publica em `/upload/...` ou o caminho base configurado no campo de arquivo.
6. Confirme que os campos de arquivo do GED e do SEFAZ RH possuem o caminho base configurado corretamente, porque a base armazena apenas o nome do arquivo.
