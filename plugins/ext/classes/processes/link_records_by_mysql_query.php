...
{
    public $current_entity_id, $action_entity_id, $where_query, $current_item_id, $process_action;
    ...
    function process($sql_data, $choices_values)
    {
        ...
        $items_query = db_query("select e.id " .  fieldtype_formula::prepare_query_select($this->action_entity_id,'') . " from app_entity_{$this->action_entity_id} e where " . $this->where_query, false);        
