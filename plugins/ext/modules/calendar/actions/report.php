...
switch($app_module_action)
{
    case 'resize':
        ...
        $end = ($_POST['view_name']=='dayGridMonth' ? strtotime('-1 day',get_date_timestamp($_POST['end'])) : get_date_timestamp($_POST['end']));
    ...
    case 'drop':
        ...
        if(isset($_POST['end']))
        {
            $end = (($_POST['view_name']=='dayGridMonth' and date('Y-m-d',get_date_timestamp($_POST['end'])) != date('Y-m-d',get_date_timestamp($_POST['start']))) ? strtotime('-1 day',get_date_timestamp($_POST['end'])) : get_date_timestamp($_POST['end']));
        }
        else
        {
