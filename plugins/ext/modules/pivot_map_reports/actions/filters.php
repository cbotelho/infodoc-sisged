...
$pivot_map_info_query = db_query("select * from app_ext_pivot_map_reports where id='" . _get::int('map_reports_id') . "'");
...
switch($app_module_action)
{
  case 'save':
		    ...
		    redirect_to('ext/pivot_map_reports/filters','map_reports_id=' . $pivot_map_info['id'] . '&reports_id=' . $_GET['reports_id']);
