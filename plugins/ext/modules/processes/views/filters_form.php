...
<?php echo form_tag('reports_filters', url_for('ext/processes/filters','action=save' .  (isset($_GET['id']) ? '&id=' . $_GET['id']:''). '&process_id=' . $_GET['process_id'] ),array('class'=>'form-horizontal')) ?>
