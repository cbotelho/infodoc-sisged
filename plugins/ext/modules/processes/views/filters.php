...
<?php echo button_tag(TEXT_BUTTON_ADD_NEW_REPORT_FILTER,url_for('ext/processes/filters_form','process_id=' . $_GET['process_id'])) ?>
...
?>
  <tr>
    <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('ext/processes/filters_delete','id=' . $v['id'] . '&process_id=' . $_GET['process_id'])) . ' ' . button_icon_edit(url_for('ext/processes/filters_form','id=' . $v['id'] . '&process_id=' . $_GET['process_id']))  ?></td>    
