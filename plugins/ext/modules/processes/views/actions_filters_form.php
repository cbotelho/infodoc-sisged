...
<?php echo form_tag('reports_filters', url_for('ext/processes/actions_filters','action=save' .  (isset($_GET['id']) ? '&id=' . $_GET['id']:''). '&process_id=' . $_GET['process_id'] . '&actions_id=' . _get::int('actions_id') ),array('class'=>'form-horizontal')) ?>
