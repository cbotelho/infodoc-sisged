...
<?php echo form_tag('login', url_for('ext/processes/actions_filters','action=delete&id=' . _get::int('id') . '&process_id=' . _get::int('process_id'). '&actions_id=' . _get::int('actions_id'))) ?>
