...
<?php echo button_tag(TEXT_BUTTON_ADD,url_for('ext/report_page/blocks_entity_table_form','report_id=' . $report_page['id'] . '&block_id=' . $block_info['id'])) ?>
...
?>
<tr>
  <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('ext/report_page/blocks_entity_table_delete','id=' . $blocks['id'] . '&report_id=' . $report_page['id']. '&block_id=' . $block_info['id'])) . ' ' . button_icon_edit(url_for('ext/report_page/blocks_entity_table_form','id=' . $blocks['id'] . '&report_id=' . $report_page['id'] . '&block_id=' . $block_info['id'])) ?></td>  
  <td><?php echo $blocks['id'] ?></td>
  <td><?php echo $app_entities_cache[$blocks['field_entity_id']]['name'] ?></td>
  <td><?php 
