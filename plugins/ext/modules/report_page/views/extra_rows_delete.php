...
<?php echo form_tag('login', url_for('ext/report_page/extra_rows','action=delete&id=' . $_GET['id'] . '&report_id=' . $report_page['id'] . '&block_id=' . $block_info['id'] . '&row_id=' . $row_info['id'])) ?>
