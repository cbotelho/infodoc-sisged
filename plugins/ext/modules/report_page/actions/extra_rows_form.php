...
else
{
    ...
    $max_sort_order_query = db_query("select max(sort_order) as sort_order from app_ext_report_page_blocks where report_id=" . $report_page['id'] . " and parent_id=" . $row_info['id']);
