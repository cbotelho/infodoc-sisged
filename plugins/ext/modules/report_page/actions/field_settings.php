    ...
    case 'fieldtype_user_photo':
        $html = '
            <div class="form-group">
                <label class="col-md-3 control-label">' . tooltip_icon(TEXT_WIDTH_INPUT_TIP) . TEXT_WIDHT  . '</label>
                <div class="col-md-9">
                    ' . input_tag('settings[width]',$settings->get('width'),['class'=>'form-control input-small']) . '                    
                </div>			
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">' . tooltip_icon(TEXT_WIDTH_INPUT_TIP) . TEXT_HEIGHT  . '</label>
                <div class="col-md-9">
                    ' . input_tag('settings[height]',$settings->get('height'),['class'=>'form-control input-small']) . '                    
                </div>			
            </div>';            
        break;
    ...
    case 'fieldtype_dynamic_date':   
        ...
        $html .= '
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ' . input_tag('settings[date_format]',$settings->get('date_format'),['class'=>'form-control input-small']) . '
