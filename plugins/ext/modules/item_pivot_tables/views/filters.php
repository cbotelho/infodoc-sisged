...
<div class="panel panel-default">
  <div class="panel-heading"><?php echo TEXT_FILTERS_FOR_ENTITY . ': <b>' . $entity_info['name'] . '</b>' ?></div>
    ...
    <?php echo button_tag(TEXT_BUTTON_ADD_NEW_REPORT_FILTER,url_for('ext/item_pivot_tables/filters_form','pivot_reports_id=' . $pivot_reports['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param)) ?>
    ...
    ?>
      <tr>
        <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('ext/item_pivot_tables/filters_delete','pivot_reports_id=' . $pivot_reports['id'] . '&id=' . $v['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param)) . ' ' . button_icon_edit(url_for('ext/item_pivot_tables/filters_form','pivot_reports_id=' . $pivot_reports['id'] . '&id=' . $v['id'] . '&reports_id=' . $current_reports_info['id'] . $parent_reports_param))  ?></td>    
...
<?php echo '<a class="btn btn-default" href="' . url_for('ext/item_pivot_tables/reports') . '">' . TEXT_BUTTON_BACK. '</a>'; ?>  
