...
<?php echo form_tag('login', url_for('ext/item_pivot_tables/filters','action=delete&pivot_reports_id=' . _get::int('pivot_reports_id') . '&id=' . $_GET['id'] . '&reports_id=' . $_GET['reports_id']. (isset($_GET['parent_reports_id']) ? '&parent_reports_id=' . $_GET['parent_reports_id']:''))) ?>
