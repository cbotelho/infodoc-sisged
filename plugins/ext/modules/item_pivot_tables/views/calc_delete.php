...
<?php $obj = db_find('app_ext_item_pivot_tables_calcs',$_GET['id']); ?>

<?php echo form_tag('login', url_for('ext/item_pivot_tables/calc','action=delete&reports_id=' . _get::int('reports_id') . '&id=' . $_GET['id'] )) ?>
