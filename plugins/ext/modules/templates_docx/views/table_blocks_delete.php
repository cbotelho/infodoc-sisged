...
<?php echo form_tag('login', url_for('ext/templates_docx/table_blocks','action=delete&id=' . $_GET['id'] . '&templates_id=' . $template_info['id'] . '&parent_block_id=' . $parent_block['id'])) ?>
