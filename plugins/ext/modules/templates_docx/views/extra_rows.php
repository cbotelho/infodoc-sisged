...
<ul class="page-breadcrumb breadcrumb">
    ...
    <?php if($parent_block['extra_type'] != 'table'): ?> 
...
{
    $back_url = 'ext/templates_docx/blocks_mysql_table';
}
else
{
    $back_url = 'ext/templates_docx/table_blocks';
}
echo '<a href="' . url_for($back_url, 'templates_id=' . $template_info['id'] . '&parent_block_id=' . $parent_block['id']) . '" class="btn btn-default"><i class="fa fa-angle-left" aria-hidden="true"></i> ' . TEXT_BUTTON_BACK . '</a>';
?>
