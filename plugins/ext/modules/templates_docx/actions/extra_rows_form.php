...
else
{
    ...
    $max_sort_order_query = db_query("select max(sort_order) as sort_order from app_ext_items_export_templates_blocks where templates_id=" . $template_info['id'] . " and parent_id=" . $row_info['id']);
