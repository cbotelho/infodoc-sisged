...
switch($field['type'])
{
    ...
    case 'fieldtype_user_roles':    
        ...
        if(!in_array($cfg->get('display_as'),['dropdown_multiple','checkboxes','dropdown_muliple']) and !isset($field_entity_id) and !in_array($field['type'],['fieldtype_related_records'])) break;
    ...
    case 'fieldtype_php_code':
        ...
        $html ='
          ...
          <div class="form-group settings-list">
            ...
            <div class="form-group settings-list">
            <label class="col-md-3 control-label" for="fields_id">' . TEXT_EXT_FONT_STYLE . '</label>
            <div class="col-md-9">' . select_checkboxes_button('settings[font_style]',$font_style_choices,$settings->get('font_style','')) . '</div>
          </div>
