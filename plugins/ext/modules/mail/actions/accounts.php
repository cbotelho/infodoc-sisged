...
switch ($app_module_action)
{
    ...
    case 'inbox_count':
        $count = mail_accounts::inbox_count();
        echo ($count < 100 ? $count : '99+');
        exit();
        break;
