...
<ul class="page-breadcrumb breadcrumb">
  ...
  <li><?php echo link_to($template_info['name'],url_for('ext/templates_xlsx/blocks','templates_id=' . $template_info['id'])) ?><i class="fa fa-angle-right"></i></li>
...
<?php echo button_tag(TEXT_BUTTON_ADD,url_for('ext/templates_xlsx/table_blocks_form','templates_id=' . $template_info['id'] . '&parent_block_id=' . $parent_block['id'])) ?>
...
?>
<tr>
  <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('ext/templates_xlsx/table_blocks_delete','id=' . $blocks['id'] . '&templates_id=' . $template_info['id']. '&parent_block_id=' . $parent_block['id'])) . ' ' . button_icon_edit(url_for('ext/templates_xlsx/table_blocks_form','id=' . $blocks['id'] . '&templates_id=' . $template_info['id'] . '&parent_block_id=' . $parent_block['id'])) ?></td>  
  <td><?= '<input value="${block_' . $blocks['id'] . '}" readonly="readonly" class="form-control input-small select-all">';  ?></td>
...
<?php echo '<a href="' . url_for('ext/templates_xlsx/blocks','templates_id=' . $template_info['id']) . '" class="btn btn-default"><i class="fa fa-angle-left" aria-hidden="true"></i> ' . TEXT_BUTTON_BACK . '</a>';?>
