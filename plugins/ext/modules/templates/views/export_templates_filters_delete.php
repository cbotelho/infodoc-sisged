...
<?php echo form_tag('filters_delete', url_for('ext/templates/export_templates_filters','action=delete&templates_id=' . $_GET['templates_id']. '&id=' . $_GET['id'] . '&reports_id=' . $_GET['reports_id']. (isset($_GET['parent_reports_id']) ? '&parent_reports_id=' . $_GET['parent_reports_id']:''))) ?>
