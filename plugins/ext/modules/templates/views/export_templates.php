                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        else
                        {
                            ...
                            {
                                $html = link_to($templates['name'], url_for('ext/templates_xlsx/blocks', 'templates_id=' . $templates['id']));
                            }
                            else
                            {
                            ...
                            {
                                $html .= ' <a href="' . url_for('ext/templates/export_templates', 'action=download_template_filename&templates_id=' . $templates['id']) . '">' . $templates['filename'] . '</a>';
                            }
                            else
                            {
                        ...
                        echo '<br>' . tooltip_text(link_to(TEXT_FILTERS, url_for('ext/templates/export_templates_filters', 'templates_id=' . $templates['id'])) . ': ' . reports::count_filters_by_reports_type($templates['entities_id'], 'export_templates' . $templates['id']))
                        ?></td>  
                    <td>
                        <?php
