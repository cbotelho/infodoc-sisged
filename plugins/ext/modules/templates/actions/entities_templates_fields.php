...
switch($app_module_action)
{
  case 'render_template_field':
        ...
        {        
          ...
          if(isset($_POST['id']))
          {
            $obj = db_find('app_ext_entities_templates_fields',$_POST['id']);
  ...
  case 'save':
      ...
      else
      {
        ...
        $check_query = db_query("select * from app_ext_entities_templates_fields where fields_id='" . db_input($field['id']) . "' and templates_id='" . db_input($_GET['templates_id']) . "'");
      ...
      redirect_to('ext/templates/entities_templates_fields','templates_id=' . $_GET['templates_id']); 
    break;
  case 'delete':
      if(isset($_GET['id']))
      {                          
        db_query("delete from app_ext_entities_templates_fields where id='" . db_input($_GET['id']) . "'");
