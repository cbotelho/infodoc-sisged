            ...
            else
            {
                ...
                foreach($choices as $id=>$name)
                {
                    $colors_html .= '
                        <tr>
                            <td>' . $name . '</td>
                            <td>' . input_color('colors[' . $id . ']',funnelchart::get_color_by_choice_id($id,$obj['colors'])) . '</td>                            
                        </tr>'; 
                }
