...
?>
<tr>
  <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('ext/funnelchart/delete','id=' . $reports['id'])) . ' ' . button_icon_edit(url_for('ext/funnelchart/form','id=' . $reports['id'])) ?></td>
  <td><?php echo $app_entities_cache[$reports['entities_id']]['name'] ?></td>
  <td><?php echo link_to($reports['name'],url_for('ext/funnelchart/view','id=' . $reports['id']),array('target'=>'_blank')) ?></td>
  <td><?php echo $choices_type[$reports['type']] ?></td>  
