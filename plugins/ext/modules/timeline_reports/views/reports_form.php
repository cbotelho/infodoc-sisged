...
<?php echo ajax_modal_template_header(TEXT_EXT_TIMELINE_REPORTS) ?>

<?php echo form_tag('configuration_form', url_for('ext/timeline_reports/reports','action=save' . (isset($_GET['id']) ? '&id=' . $_GET['id']:'') ),array('class'=>'form-horizontal')) ?>
...
<div class="tab-content">
  <div class="tab-pane fade active in" id="general_info">
    ...
    <div class="form-group">
	  	<label class="col-md-3 control-label" for="in_menu"><?php echo tooltip_icon(TEXT_EXT_IN_MENU_SUBENTITY_REPORT) . TEXT_IN_MENU ?></label>
	    <div class="col-md-9">	
...
{ 
  ...
  $('#reports_entities_fields').load('<?php echo url_for("ext/timeline_reports/reports","action=get_entities_fields")?>',{entities_id:entities_id, id:'<?php echo $obj["id"] ?>'},function(response, status, xhr) {
    if (status == "error") {                                 
