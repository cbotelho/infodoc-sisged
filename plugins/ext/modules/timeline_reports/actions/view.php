...
$reports_info_query = db_query("select * from app_reports where entities_id='" . db_input($reports['entities_id']). "' and reports_type='timelinereport" . $reports['id']. "' and created_by='" . $app_logged_users_id . "'");
