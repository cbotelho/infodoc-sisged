...
switch($app_module_action)
{
    ...
    case 'get_entities_fields':
        ...
        $fields_query = db_query("select * from app_fields where type in ('fieldtype_input_date','fieldtype_input_date_extra','fieldtype_input_datetime','fieldtype_date_added','fieldtype_dynamic_date') and entities_id='" . db_input($entities_id) . "'");
