...
switch($app_module_action)
{
	...
	case 'prepare_new_item':
		...
		{			
			$mm_query = db_query("select id,mm_items_id from app_mind_map where mm_id='" . $_POST['mm_id'] . "' and entities_id='" . $mind_map->entities_id . "' and reports_id='" . $mind_map->reports_id . "' and parent_entity_item_id = '" . $mind_map->parent_entity_item_id . "'");
