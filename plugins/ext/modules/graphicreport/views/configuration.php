...
<div class="row">
  ...
  <div class="col-md-3">
    <?php echo form_tag('reports_filter_form',url_for('ext/graphicreport/configuration','action=set_reports_filter')) ?>
      <?php echo select_tag('reports_filter',entities::get_choices_with_empty(),$graphicreport_entity_filter,array('class'=>'form-control input-large float-right','onChange'=>'this.form.submit()')) ?>
    </form>
  </div>
</div>   
...
<?php  
  ...
  {              
        echo ($fields_cahce[explode(':',$id)[0]]??'')  . '<br>';
  }  
?>
  </td>
