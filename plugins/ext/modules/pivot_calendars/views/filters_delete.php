...
<?php echo form_tag('login', url_for('ext/pivot_calendars/filters','action=delete&calendars_id=' . _get::int('calendars_id'). '&id=' . $_GET['id'] . '&reports_id=' . $_GET['reports_id']. (isset($_GET['parent_reports_id']) ? '&parent_reports_id=' . $_GET['parent_reports_id']:''))) ?>
