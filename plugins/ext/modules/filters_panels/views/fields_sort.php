...
<?php echo form_tag('choices_form', url_for('ext/filters_panels/fields','action=sort&redirect_to=' . $app_redirect_to . '&entities_id=' . $_GET['entities_id'] . '&panels_id=' . $_GET['panels_id']),array('class'=>'form-horizontal')) ?>
