...
switch($app_module_action)
{
  case 'save':
      ...
      $sql_data = array(                        
           ...
           'fields_for_search'=>(isset($_POST['fields_for_search']) ? implode(',',$_POST['fields_for_search']):''),
  ...
  case 'get_entities_fields':
        ...
        $html = '
         <div class="form-group">
            ...
            <div class="col-md-8">	
          	   ' .  select_tag('fields_for_search[]',$choices, $obj['fields_for_search'],array('class'=>'form-control input-xlarge chosen-select','multiple'=>true)) . '
        ...
        $html .= '
         <div class="form-group">
            ...
            <div class="col-md-8">
          	   ' .  select_tag('fields_in_listing[]',$choices, $obj['fields_in_listing'],array('class'=>'form-control input-xlarge chosen-select chosen-sortable','multiple'=>true,'chosen_order'=>$obj['fields_in_listing'])) . '               
            </div>
          </div>
        ';
