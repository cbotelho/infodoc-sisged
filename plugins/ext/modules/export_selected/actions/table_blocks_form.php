...
else
{
    ...
    $max_sort_order_query = db_query("select max(sort_order) as sort_order from app_ext_export_selected_blocks where templates_id=" . _GET('templates_id') . " and parent_id=0");
