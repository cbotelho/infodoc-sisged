...
<ul class="page-breadcrumb breadcrumb">
  <li><?php echo link_to(TEXT_EXT_EXPORT_SELECTED,url_for('ext/export_selected/templates'))?><i class="fa fa-angle-right"></i></li>
...
<?php echo button_tag(TEXT_BUTTON_ADD,url_for('ext/export_selected/table_blocks_form','templates_id=' . $template_info['id'])) ?>
...
?>
<tr>
  <td style="white-space: nowrap;"><?php echo button_icon_delete(url_for('ext/export_selected/table_blocks_delete','id=' . $blocks['id'] . '&templates_id=' . $template_info['id'])) . ' ' . button_icon_edit(url_for('ext/export_selected/table_blocks_form','id=' . $blocks['id'] . '&templates_id=' . $template_info['id'] )) ?></td>  
...
<?php echo '<a href="' . url_for('ext/export_selected/templates','templates_id=' . $template_info['id']) . '" class="btn btn-default"><i class="fa fa-angle-left" aria-hidden="true"></i> ' . TEXT_BUTTON_BACK . '</a>';?>
