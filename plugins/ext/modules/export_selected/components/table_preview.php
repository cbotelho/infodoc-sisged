...
//extra rows
$rows_query = db_query("select b.* from app_ext_export_selected_blocks b where b.block_type='thead' and b.templates_id = " . $template_info['id'] . " and b.parent_id = " . $parent_block_id . " order by b.sort_order, b.id");
while($rows = db_fetch_array($rows_query))
{
    $blocks_query = db_query("select b.* from app_ext_export_selected_blocks b where b.templates_id = " . $template_info['id'] . " and b.parent_id = " . $rows['id'] . " order by b.sort_order, b.id");
...
//extra rows
$rows_query = db_query("select b.* from app_ext_export_selected_blocks b where b.block_type='tfoot' and b.templates_id = " . $template_info['id'] . " and b.parent_id = " . $parent_block_id . " order by b.sort_order, b.id");
while($rows = db_fetch_array($rows_query))
{
    $blocks_query = db_query("select b.* from app_ext_export_selected_blocks b where b.templates_id = " . $template_info['id'] . " and b.parent_id = " . $rows['id'] . " order by b.sort_order, b.id");
