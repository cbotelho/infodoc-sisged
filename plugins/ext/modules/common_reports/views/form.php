        ...
        <div class="tab-content">
            <div class="tab-pane active" id="form_tab_general">  
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">	
                        <?php echo textarea_tag('description', $obj['description'], array('class' => 'form-control editor','toolbar'=>'small')) ?>
                    </div>			
                </div> 
...
?>
                ...
                <div class="form-group">    
                    <label class="col-md-3 control-label" for="displays_assigned_only"><?php echo tooltip_icon(TEXT_DISPLAYS_ASSIGNED_ITEMS_ONLY_INFO) . TEXT_DISPLAYS_ASSIGNED_ITEMS_ONLY ?></label>
                    <div class="col-md-9">	
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">	
                        <?php echo select_tag('users_groups[]', access_groups::get_choices(), $obj['users_groups'], array('class' => 'form-control chosen-select', 'multiple' => 'multiple')) ?>      
                    </div>			
                </div> 

                <div class="form-group">
                    <label class="col-md-3 control-label" for="users_groups"><?php echo TEXT_USERS ?></label>
                    <div class="col-md-9">	
