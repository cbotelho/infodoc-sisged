...
define('TEXT_FORMULA_TIP','Use [Field ID] to setup field value in formula. Example: ([36]+[54])/2. Where 36 and 54 are ID of numeric fields. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=25" target="_blank"><u>See more examples.</u></a>');
...
define('TEXT_MAX_UPLOAD_FILE_SIZE_TIP','<a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=10" target="_blank">' . 'How to change this value?' . '</a>');
...
define('TEXT_NOTIFICATIONS_SCHEDULE_TIP','Befor enable this feature you have to configure CRON_HTTP_SERVER_HOST in config/server.php and run the file every hour (<a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=70" target="_blank"><u>Cron</u></a>):');
...
define('TEXT_SEND_EMAILS_ON_SCHEDULE_INFO','Before you enable this feature, you must install the scheduled task every minute (<a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=70" target="_blank"><u>Cron</u></a>):');
...
define('TEXT_SEND_EMAILS_ON_SCHEDULE_DESCRIPTION','Before you enable this feature, check <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=8" target="_blank"><u>restrictions on sending mail</u></a> on your server.');
...
define('TEXT_FORMS_FIELDS_DISPLAY_RULES_INFO','For fields of type Drop Down you have the ability to customize the display of fields, depending on the selected list values. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=64" target="_blank">Read more</a>');
...
<p>Also we recommend you to visit the "<a href=" https://docs.infodocsisged.com.br/m.br/index.php" target="_blank">Documentation</a>". There you will find various tips on setting up the system.</p>
...
define('TEXT_ENTITY_ACCESS_INFO_EXTRA','<br>"Views All. Actions with Assigned" allows you to perform an action only with the assigned records.<br>"Update Selected" will be available when the Extension is installed. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=89" target="_blank">More Details</a>.');
...
define('TEXT_USERS_ALERTS_INFO','On this page you have the ability to create alerts for selected users or groups of users. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=15" target="_blank">Read more</a>.');
...
define('TEXT_CHOICES_VALUE_INFO','The value can be used in formula calculations. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=25#get_value" target="_blank">Read more</a>');
...
define('TEXT_JS_FORMULA_TIP','Use [Field ID] to setup field value in formula. Example: ([36]+[54])/2. Where 36 and 54 are ID of numeric fields. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=72" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ACCESS_ALLOCATION_RULES_INFO','On this page you have the ability to configure user access depending on the values of the selected field. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=28" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_REPORTS_GROUPS_INFO','Group reports by a specific entity or data and display them on a separate page. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=68" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_MYSQL_QUERY_TOOLTIP','A special type of field for creating a custom MySQL query to the selected entity. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=24" target="_blank"><u>Read more.</u></a>.');
...
define('TEXT_FIELDTYPE_MIND_MAP_TOOLTIP','Special field type to build mind map. A mind map is a diagram used to visually organize information. A mind map is hierarchical and shows relationships among pieces of the whole. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=19" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_LISGIN_CONFIGURATION_INFO','On this page, you can customize the appearance of the list of records. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=65" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_LDAP_INFO','This feature enables LDAP authentication and creates users in a database that successfully authenticate. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=9" target="_blank"><u>Read more.</u></a>');
define('TEXT_FIELDTYPE_DAYS_DIFFERENCE_TITLE','Days difference');
define('TEXT_FIELDTYPE_DAYS_DIFFERENCE_TOOLTIP','A special type of field that calculates the difference in days between two dates. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=88" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_HOURS_DIFFERENCE_TOOLTIP','A special type of field that calculates the difference in hours between two dates. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=88" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_HOLIDAYS_INFO','Holiday dates can be excluded when calculating the difference of days. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=88" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_YEARS_DIFFERENCE_TOOLTIP','A special type of field that calculates the difference in years between two dates. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=88" target="_blank"><u>Read more.</u></a>');
define('TEXT_CALCULATE_DIFFERENCE_DAYS','Calculate the difference in days');
define('TEXT_FIELDTYPE_PHONE','Phone');
define('TEXT_FIELDTYPE_PHONE_TOOLTIP','A special field type to enter phone number. Can be configured to make calls. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=62" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_DASHBOARD_CONFIGURATION_INFO','You can add info blocks or pages on home page. In info block you can output information about current user. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=13" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_HELP_SYSTEM_INFO','Create informational pages and announcements for a specific entity. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=27" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ENTITIES_PAGE_INFO','Rukovoditel allows you build your own database by adding new entities and relationships. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=12" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_GOOGLE_MAP_TOOLTIP','Field to display the marker on the map. The coordinates of the marker are determined automatically by the entered address. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=17" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_DEFAULT_FILTER_PANEL_INFO','You can disable this panel or show it to certain groups of users. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=67" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_TAGS_TOOLTIP','A special field type that allows you to select an existing option or dynamically create a new option in the drop-down list. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=79" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ALL_USERS_APPROVED_INFO','Select the action that will be run once all users has be approved record. The action can be configured in <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=31" target="_blank">Extension->Automatic Actions</a>.');
...
define('TEXT_FORM_CONFIG_INFO','On this page, you have the ability to sort the fields in the form, create additional tabs for the fields, and embed your JavaScript code into the form. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=64" target="_blank">Read More</a>.');
...
define('TEXT_DEFAULT_NOTIFICATIONS_INFO','By default, notifications are sent to all assigned users. Use the Users field type to assign users to a record.<br>For more flexible notification settings, use the <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=75" target="_blank">Mail sending rules</a>.');
...
define('TEXT_RECORDS_VISIBILITY_INFO','Configure the visibility of records depending on the value of the fields. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=82" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_SIGNATURE_TOOLTIP','Field allows add Name and Signature. Not related to app users. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=80" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_2STEP_VERIFICATION_INFO','If enabled, the user, when entering the system, in addition to the credentials, will need to enter a special code sent to the user by email or SMS. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=83" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_ENTITY_MYSQL_QUERY_TIP','Add a MySQL condition to select only certain records. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=78" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_PUBLIC_REGISTRATION_TIP','Your customers will be able to register themselves on the app. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=14" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_DIGITAL_SIGNATURE_TOOLTIP','This field is to work with digital signature modules that allows you sign documents. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=84" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_AJAX_REQUEST_TOOLTIP','A special type of field that allows you to perform calculations on the fly in the form of a record. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=99" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_ITEMS_BY_QUERY_TOOLTIP','A special type of field that displays a list of records by a custom database query. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=101" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_CODE_ON_ITEM_PAGE','The entered code will be embedded on the item page. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=66" target="_blank"><u>Read more.</u></a>');
define('TEXT_FIELDTYPE_PHP_CODE_TITLE','PHP Code');
define('TEXT_FIELDTYPE_PHP_CODE_TOOLTIP','A special field type that allows you to run your own PHP code. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=104" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_PROCESS_BUTTON_TOOLTIP','A special type of field that can be used to display the button from automate actions directly in the list of records. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=105" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ASSIGN_USER_TO_MULTIPLE_GROUPS_INFO','The user will be able to switch between groups in his personal account. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=116" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_SOCIAL_LOGIN_INFO','On this page, you can configure authorization via popular social networks. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=118" target="_blank"><u>Read more.</u></a>');
define('TEXT_GUEST_LOGIN','Guest login');
define('TEXT_GUEST_LOGIN_INFO','Set up guest access to the app without entering a username and password. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=120" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_NESTED_CALCULATIONS_TOOLTIP','A special type of field for performing calculations on nested records within a single tree branch in a tree list. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=123" target="_blank"><u>Read more.</u></a>'
...
define('TEXT_FIELDTYPE_ENTITY_MULTILEVEL_PARENT_FIELD_VALUE_TIP','If you have created a separate field in which you select a value from the parent entity, select this field to establish a relationship with the lists. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=126" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ADD_RECORDS_TO_FAVORITES_TIP','The star icon will appear on the entries page, which allows users to add entries to favorites. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=127" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_IMAGE_MAP_NESTED_TOOLTIP','A special type of field for displaying custom maps. Users will be able to upload their own map images. Markers on the map are records from a nested entity. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=18" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_GLOBAL_VARS_INFO','Create global constants that can be used in your own PHP code or MySQL Formula  field type. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=128" target="_blank"><u>Read more.</u></a>');
define('TEXT_ADD_FOLDER','Add Folder');
define('TEXT_CUSTOM_PHP','Custom PHP');
define('TEXT_CUSTOM_PHP_INFO','Create your own Functions and Classes that can be used in PHP Code field or PHP code in Processes. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=129" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_TAB_GROUPS_INFO','If there are a large number of tabs, then to save space in the form, you can group the tabs. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=64" target="_blank"><u>Read more.</u></a>');
define('TEXT_FORM_WIZARD_INFO','Split data entry by Steps using Tabs. If this option enabled, the user have to enter data step by step. The Save button displays on last the Tab in this case. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=130" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_EMAILS_LAYOUT_INFO','Create a HTML layout for emails in the app. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=132" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_INPUT_DATE_EXTRA_TOOLTIP','Calendar for selecting date and time, which has a number of additional display settings. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=137" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_LOGS_INFO','Attention: do not leave the logs permanently enabled, as they create an additional load on the server. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=138" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_NESTED_ENTITIES_MENU_INFO','In order to save space on the page, you can combine entities into groups. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=144" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_RELATED_MAIL_TOOLTIP','If you are using <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=32" target="_blank">Mail Integration</a> feature, with this field type you can display related mails in list of records. <a h https://docs.infodocsisged.com.br/ed.com.br/index.php?p=147" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_ONLYOFFICE_TOOLTIP','Uploaded files can be viewed and modified using the ONLYOFFICE Document Editor. Access to the ONLYOFFICE server is required for this field to work. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=149" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FILE_STORAGE_TOOLTIP','A special field that allows you to upload files to the file storage service. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=150" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_GOOGLE_DRIVE_TOOLTIP','A special field that allows you to upload files to the file storage service Google Disk. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=153" target="_blank"><u>Read more.</u></a>');
define('TEXT_FIELDTYPE_DROPBOX_TOOLTIP','A special field that allows you to upload files to the file storage service Dropbox. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=152" target="_blank"><u>Read more.</u></a>');
define('TEXT_FIELDTYPE_YANDEX_DISK_TOOLTIP','A special field that allows you to upload files to the file storage service Yandex Disk. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=151" target="_blank"><u>Read more.</u></a>');

//new defines for version 3.6
define('TEXT_CURRENT_APP_VERSION', 'App Version');
define('TEXT_UPDATE_INSTRUCTION','<a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=63" target="_blank"><i class="fa fa-hand-o-right"></i> Update Instructions</a>');
define('TEXT_COMPOSITE_UNIQUE_FIELDS','Composite unique fields');
define('TEXT_COMPOSITE_UNIQUE_FIELDS_INFO','This functionality is designed to combine unique fields into groups.  The uniqueness check will be performed for the group, the fields are compared in pairs. You do not need to set the uniqueness flag for a separate field. <a href=" https://docs.infodocsisged.com.br/m.br/index.php?p=160" target="_blank"><u>Read more.</u></a>');
