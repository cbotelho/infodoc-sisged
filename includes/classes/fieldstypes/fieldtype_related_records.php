...
class fieldtype_related_records
{
    ...
    function get_configuration($params = array())
    {
        ...
        $cfg[TEXT_SETTINGS][] = array('title' => TEXT_COLLAPSED, 'name' => 'is_collapsed', 'type' => 'checkbox');
        $cfg[TEXT_SETTINGS][] = array('title' => TEXT_DISPLAY_SEARCH_BAR, 'name' => 'display_search_bar', 'type' => 'checkbox');
