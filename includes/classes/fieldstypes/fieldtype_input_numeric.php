...
class fieldtype_input_numeric
{
    ...
    function get_configuration($params = array())
    {
        ...
        $cfg[TEXT_COLOR][] = array('title' => TEXT_NEGATIVE_NUMBER_COLOR, 'name' => 'negative_number_color', 'type' => 'colorpicker');
    ...
    function render($field, $obj, $params = array())
    {
        ...
        if(($params['is_new_item']??false) == true and strlen($cfg->get('default_value')) > 0)
        {
