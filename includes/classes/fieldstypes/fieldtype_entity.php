...
class fieldtype_entity
{
    ...
    static function get_choices($field, $params = array(), $value = '', &$parent_entity_item_is_the_same=false)
    {
        ...
        if (strlen($value))
        {
            $listing_sql_query = "(" . $listing_sql_query . ") or e.id in (" . db_input_in($value) . ") ";
        }
