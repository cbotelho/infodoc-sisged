...
//path to libs
    //dompdf
    define('CFG_PATH_TO_DOMPDF','includes/libs/dompdf/3.1.0/vendor/autoload.php');
...
//include classes
    ...
    require('includes/classes/audiorecorder.php'); 
    require('includes/classes/file_storage_field.php'); 
...
//include field types
    ...
    require('includes/classes/fieldstypes/fieldtype_onlyoffice.php');
    require('includes/classes/fieldstypes/fieldtype_dropbox.php');
    require('includes/classes/fieldstypes/fieldtype_yandex_disk.php');    
    require('includes/classes/fieldstypes/fieldtype_google_drive.php');    
...
//users 
    ...
    require('includes/classes/users/who_is_online.php');
    require('includes/classes/users/last_user_action.php');
    require('includes/classes/users/blocked_forms.php');
    require('includes/classes/users/login_attempt.php');
...
//items
    ...
    require('includes/classes/items/composite_unique_fields.php');        
...
//onlyoffice
    require('includes/classes/onlyoffice/onlyoffice.php');    
...
//configuration added in next versions
    ...
    if(!defined('CFG_WHO_IS_ONLINE_STATUS')) define('CFG_WHO_IS_ONLINE_STATUS',0);
    if(!defined('CFG_WHO_IS_ONLINE_INTERVAL')) define('CFG_WHO_IS_ONLINE_INTERVAL',3);
    
    if(!defined('CFG_AUTO_LOGOUT_INACTION_USERS')) define('CFG_AUTO_LOGOUT_INACTION_USERS',0);
    if(!defined('CFG_AUTO_LOGOUT_INACTION_TIME')) define('CFG_AUTO_LOGOUT_INACTION_TIME',15);
    if(!defined('CFG_BLOCK_RECORD_FORM_WHEN_EDITING')) define('CFG_BLOCK_RECORD_FORM_WHEN_EDITING',0);
    if(!defined('CFG_BLOCK_RECORD_FORM_WARNIGN_TEXT')) define('CFG_BLOCK_RECORD_FORM_WARNIGN_TEXT','');
    if(!defined('CFG_ALLOW_USER_PUBLIC_STATUS')) define('CFG_ALLOW_USER_PUBLIC_STATUS',0);
    
    if(!defined('CFG_ENABLE_LOGIN_ATTEMPT')) define('CFG_ENABLE_LOGIN_ATTEMPT',true);
    if(!defined('CFG_NUMBER_LOGIN_ATTEMPTS')) define('CFG_NUMBER_LOGIN_ATTEMPTS',3);
    if(!defined('CFG_NUMBER_MINUTES_IP_BLOCKED')) define('CFG_NUMBER_MINUTES_IP_BLOCKED',5);
    if(!defined('CFG_LOGIN_ATTEMPT_TRUSTED_IP')) define('CFG_LOGIN_ATTEMPT_TRUSTED_IP','');
...
//Set locale information to fix issue with pathinfo() and filenames with utf8
if(!defined('CFG_APP_LOCALE')) define('CFG_APP_LOCALE','en_US.UTF-8');
setlocale(LC_ALL, CFG_APP_LOCALE);
